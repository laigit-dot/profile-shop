...
describe('application smoke tests', () => {
  it('returns the interactive gallery from the root endpoint', async () => {
    ...
    expect(body).toContain('function extractEmbedUrl')
    expect(body).toContain('function applyFromEmbedText')
    expect(body).toContain('function syncControlsFromState')
    expect(body).toContain('id="markdown"')
    expect(body).toContain('<textarea id="markdown"')
    expect(body).toContain('<img\\n  src="\' + url + \'"\\n  alt="GitHub card"\\n/>')
    expect(body).not.toContain('![GitHub card](')
    expect(body).not.toContain('<pre id="markdown">')
