...
reported privately to the current maintainer, [@laigit-dot](https://github.com/laigit-dot).
Do not include sensitive details in a public issue. If no private contact route
is visible, open a neutral issue asking the maintainer to provide one, without
identifying people or describing the incident.
